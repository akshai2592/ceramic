    ...
    <Box direction="row" flex>
      ...
      <Box direction="column" flex pad="medium">
        <Form
          ...
          onSubmit={onSubmit}>
          <FormField name="title" htmlFor="text-input-title" label="Course Name">
            <TextInput autoFocus disabled={isLoading} id="text-input-title" name="title" />
          </FormField>
          <FormField name="text" htmlFor="text-input-text" label="Branch">
          ...
          <Box direction="row" gap="medium">
            <Button
              ...
              primary
              style={{ color: 'white' }}
              label={isLoading ? 'Publishing...' : 'Apply Course'}
            />
